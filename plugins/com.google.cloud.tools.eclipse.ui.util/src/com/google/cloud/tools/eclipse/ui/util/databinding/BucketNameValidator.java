 ...
 * <p>
 * Use lowercase letters, numbers, hyphens (-), and underscores (_). You can also use a dot (.) to
 * form a valid top-level domain (e.g., example.com). Format: You must start and end the name with
 * a number or letter. Bucket names must contain 3 to 63 characters. Names containing dots can
