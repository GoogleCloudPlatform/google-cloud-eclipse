...
public class DeployPropertyPageForStandardProjectTest
    extends AbstractDeployPropertyPageForProjectsTest<DeployPreferencesPanel> {
  ...
  @Override
  protected Class<DeployPreferencesPanel> getPanelClass() {
    return DeployPreferencesPanel.class;
  }
}
