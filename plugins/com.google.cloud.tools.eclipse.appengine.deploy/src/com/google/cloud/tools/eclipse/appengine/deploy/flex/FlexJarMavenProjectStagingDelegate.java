...
/**
 * Copies a runnable JAR (an App Engine flexible app) to the given staging directory for Maven
 * projects (in addition to copying {@code app.yaml} handled by the base class). The JAR is
 * generated by running {@code mvn package} through the Maven launch configuration mechanism.
 *
