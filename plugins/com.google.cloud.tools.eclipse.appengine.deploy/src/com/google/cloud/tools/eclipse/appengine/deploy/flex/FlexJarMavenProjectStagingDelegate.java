...
/**
 * Copies a runnable JAR (an App Engine flexible app) to the given staging directory (in addition to
 * copying {@code app.yaml} handled by the base class) for Maven projects with the App Engine
 * flexible JAR facet. The JAR is generated by running {@code mvn package} through the Maven launch
