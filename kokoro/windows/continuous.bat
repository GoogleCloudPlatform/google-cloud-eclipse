...
rem To speed up build, download and unpack the preloaded M2 repo.
pushd %USERPROFILE%
...
rem (Currently, this workaround is mostly unnecessary, as we download and unpack
rem the M2 repo preloaded with all the JARs. However, we leave it here, since
rem test projects may change in the future.)
